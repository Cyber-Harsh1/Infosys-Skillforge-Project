    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // ✅ Public Quiz routes
                        .requestMatchers("/quizzes/all", "/api/quizzes/all", "/api/quizzes/public/**").permitAll()

                        // ✅ Student-specific routes
                        .requestMatchers("/api/quizzes/submit-attempt", "/api/quizzes/user-attempts/**")
                        .hasAuthority("STUDENT")

                        // ✅ Instructor/Admin routes
                        .requestMatchers("/api/quizzes/generate", "/api/quizzes/attempts", "/api/quizzes/topic/**")
                        .hasAnyAuthority("INSTRUCTOR", "ADMIN")

                        // ✅ Course Management
                        .requestMatchers("/api/courses/**", "/api/subjects/**", "/api/topics/**", "/api/materials/**")
                        .hasAnyAuthority("INSTRUCTOR", "ADMIN")
